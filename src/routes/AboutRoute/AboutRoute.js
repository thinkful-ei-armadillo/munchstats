    ...
    render() {
        return (
            <section className="aboutPage">
                ...
                <p>Munch Stats is a meal tracking app. What makes Munch Stats different is our approach to building meals within the app. Using the Edemam API, you can build and track your meals ingredient by ingredient and save each meal for multiple trackings. You can also set daily goals for calories, carbohydrates, fat, and/or protein and track how your daily consumption compares to your goals.</p>
                ...
                <ul className="aboutList">
                    ...
                    <li><span className="aboutListItems">Logging Meals & Snack:</span> If you click the button to log a meal or snack, you are taken to where you can begin tracking your nutrition. Using the meals you just created, you can track those meals as either breakfast, brunch, lunch, or dinner. Had a banana as a snack? You can track that as well by logging snacks!</li>
                    <li><span className="aboutListItems">Setting Goals:</span> If you click on your name in the top right corner of your screen, you're taken to your profile page. On this page, you can set your daily goals for either calories, carbs, fat, and/or protein. You can also change your display to dark mode if you'd like.</li>
                    <li><span className="aboutListItems">Tracking Your Goals:</span> From the dashboard, if you click on the button to view your past reports, you are taken to your daily reports page where you can see how you are eatting compared to your daily goals that you just set up!</li>
                </ul>
